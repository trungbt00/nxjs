                    ...
                    <Col key={event.id}>
                        <div className="p-3 ">
                            {event.imageRepresent && (
                                <div className="mb-2">
                                    <img
                                        src={event.imageRepresent.startsWith('http') ? event.imageRepresent : `/${event.imageRepresent}`}
                                        alt={event.title}
                            ...
                            <div>
                                <h6>
                                    <Link
                                        href={
                                            event.id.includes('articlefn') ? `/articlefn/${event.id}`
                                                : event.id.includes('article') ? `/article/${event.id}`
                                                        : `/news/${event.id}`
                                        }
